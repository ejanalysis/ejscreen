...
# States_2021_LOOKUP                    NULL           NULL        NULL            "2015-2019" "2.0"            NULL                 NULL              NULL "early 2022"
...
# bg21plus                              NULL           NULL        NULL            "2015-2019" "2.0"            NULL                 NULL              NULL 2022        
...
# bg22plus                              2020           "2016-2020" "3/17/2022"     NULL        "2.1"            "September 2022"     "bg22"            NULL NULL        
...
# points1000example       NULL           NULL        NULL            NULL        NULL             NULL                 NULL              NULL NULL       
# points100example        NULL           NULL        NULL            NULL        NULL             NULL                 NULL              NULL NULL       
