...
#' @param ... Optional parameters to pass to \code{\link{ejscreen.create}}
#'   which uses formulas to create indicators from raw values.
#'   e.g. can pass clean=FALSE that is in turn passed eventually to clean.fips()
