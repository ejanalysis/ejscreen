...
#'   you can look where that falls in the percentiles and see that say 81% of the US population had lower scores:
...
#'       # Those traffic scores had been at the 62d and 83d percentiles within NY State (83 percent
