#' @name bg22
#' @docType data
#' @title blockgroup data from the EPA EJScreen dataset (ACS 2016-2020, etc.)
#' @description 
#'  \preformatted{
#'  This is the EPA EJScreen dataset version 2.1 with additional columns added.
...
#'  Vintage
#'
#'  - EJScreen 2.1 was released by EPA in October 2022. 
#'    It is called bg22 here.
#'    It uses ACS 2016-2020, which the Census Bureau released March 17, 2022
#'    (delayed from Dec 2021).
#'
...
#'  }
#' @concept datasets
#' @format data.frame with 242335 rows (block groups) and approx 175 columns
NULL
