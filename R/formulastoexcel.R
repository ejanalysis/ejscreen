if (1==0) {
  formulastoexcel <-
    function(x = ejscreenformulas,
      ...
      # Based on ejscreen::ejscreenformulas (tabular data version of formulas)
      ...
      #
      # t(ejscreen::ejscreenformulas[c(57),])
      # 57
      # gdbfieldname      NA
      # Rfieldname        "num1pov"
      # acsfieldname      NA
      ...
      # , which should be enough (470 needed right now for ejscreen::ejscreenformulas)
      exceletters <-
