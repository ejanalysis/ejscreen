#' @name bgDemographicSubgroups2015to2019
#' @docType data
#' @title Demographic subgroups of race/ethnicity by block group (ACS2015-2019 for bg21 and late 2021v of EJSCREEN)
#' @description This 2015-2019 data will fit with the bg21 data once available,
...
#'   \cr
#'     ########################################## \cr
#'     # How to merge demographic subgroup info into the basic EJSCREEN bg19 dataset: \cr
#'     ########################################### \cr
#'     d <- bgDemographicSubgroups2015to2019 \cr
