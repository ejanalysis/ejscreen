...
#'      \cr
#'   \code{
#'   #  bg <- 0 # to be completed  ------------------   \cr
#'   
#'     } \cr\cr
#'   # 
#'   # add fields called FIPS.TRACT, FIPS.COUNTY, FIPS.ST, countyname. \cr\cr
#'  
#'   # add lat, lon fields for block group centroids, via \link[proxistat]{bg.pts} from proxistat package:\cr
